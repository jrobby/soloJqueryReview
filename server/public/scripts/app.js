/**
 * Created by robbynewman on 1/4/16.
 */
//
//
...
//        var $content = '';
//
//        var director = response [it].Director;
//        var title = response[it].Title;
//
//        var rating = response[it].Rating;
//
//        var runtime = reponse[it].Runtime;
//
//        $content = "Title: " + title + '<br/>' + " Director: " + director + "Rating: " + rating +
//            "Runtime: " + runtime;
//
//
...
console.log('hi');
$.ajax("/data/data.json").then(function(response) {
    for(var it=0; it<response.length; it++) {
